...
| 13 | 13-captura-evidencia-escaneo.md | Pendiente | Captura de pantalla como `Evidencia` del hallazgo automático (reutiliza el esquema v3 de Dexie y `EvidenciasService` de la spec 16) |
