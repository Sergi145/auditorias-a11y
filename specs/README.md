...
| 19 | [19-traduccion-axe.md](./19-traduccion-axe.md) | Implemented | Notas y descripciones de captura de los hallazgos automáticos de axe-core guardadas en español (diccionario por id de regla, fallback al inglés), en los dos modos de escaneo |
